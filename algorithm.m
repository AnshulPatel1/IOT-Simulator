...
% Last Modified by GUIDE v2.5 31-Jul-2017 16:29:27
...
% varargin   command line arguments to algorithm (see VARARGIN)
...
% UIWAIT makes algorithm wait for user response (see UIRESUME)
