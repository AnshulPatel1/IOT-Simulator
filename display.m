...
% Last Modified by GUIDE v2.5 31-Jul-2017 16:32:26
...
% --- Executes on button press in savebutton2.
function savebutton2_Callback(hObject, eventdata, handles)
% hObject    handle to savebutton2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
MainGUI; 
